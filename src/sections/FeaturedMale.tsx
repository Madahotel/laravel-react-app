...
export default function FeaturedMale() {
  ...
  return (
    <section
      ref={sectionRef}
      id="males"
      className="relative w-full bg-[#0B0B0C] py-20 lg:py-32 z-[30]"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center max-w-6xl mx-auto">
          ...
          <div ref={imageRef} className="relative">
            <div className="aspect-[3/4] rounded-xl overflow-hidden">
              <img
                src="/images/male_feature.jpg"
                alt="Featured Male"
                className="w-full h-full object-cover"
              />
            </div>
            <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-[#C79A6B] rounded-lg flex items-center justify-center">
          ...
          <div ref={contentRef} className="lg:pl-8">
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <div className="glass-card p-4">
                <p className="text-[#C79A6B] font-bold text-lg">1.5 yrs</p>
                <p className="text-sm text-[#B8B0A8]">Age</p>
              </div>
              <div className="glass-card p-4">
                <p className="text-[#C79A6B] font-bold text-lg">Black</p>
                <p className="text-sm text-[#B8B0A8]">Color</p>
              </div>
              <div className="glass-card p-4">
                <p className="text-[#C79A6B] font-bold text-lg">78 kg</p>
                <p className="text-sm text-[#B8B0A8]">Weight</p>
              </div>
              <div className="glass-card p-4">
                <p className="text-[#C79A6B] font-bold text-lg">SABBS</p>
